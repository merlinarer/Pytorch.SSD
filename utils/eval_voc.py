...
class VOCMap:
    ...
    def write_voc_results_file(self, all_boxes, img_list):
        for cls_ind, cls in enumerate(labelmap):
            ...
            with open(filename, 'wt') as f:
                ...
                # embed()
                for im_ind, index in enumerate(img_list):
                    ...
                    for k in range(dets.shape[0]):
                        f.write('{:s} {:.3f} {:.1f} {:.1f} {:.1f} {:.1f}\n'.
                                format(index.rstrip('.jpg'), dets[k, -1],
    ...
    def evaluate_detections(self, box_list, img_list):
        self.write_voc_results_file(box_list, img_list)
        self.do_python_eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--trained_model',
                        default='pretrained/SSD_0.1_bs32_loss3_epoch_395.pth', type=str,
    ...
    dataset = MyVOCDataset(root=args.voc_root + 'VOC' + '2007', transform=BaseTransform(), type='test')
